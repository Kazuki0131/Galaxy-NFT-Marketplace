...
abi_file_list = ['./contracts/compiled/GalaxyArtNFT_abi.json','./contracts/compiled/GalaxyArtMarket_abi.json']
...
if st.button("Display"):
    ...
    token_uri = contract_1.functions.tokenURI(token_id).call()
